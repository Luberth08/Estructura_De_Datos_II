...
class Dados:
    ...
    def __init__(self, dados: list = [1,1,1,1,1]):
        '''
    ...
    def es_escalera(self):
        ...
        return sorted_dados in ([1, 2, 3, 4, 5], [2, 3, 4, 5, 6], [3, 4, 5, 6, 1])
    ...
    def obtener_jugada(self):
        ...
        '''
        if self.es_grande():
            return Jugada.GRANDE
        elif self.es_poker():
            return Jugada.POKER
        elif self.es_full():
            return Jugada.FULL
        elif self.es_escalera():
            return Jugada.ESCALERA
        elif self.es_trica():
            return Jugada.TRICA
        elif self.es_par():
            return Jugada.PAR
    ...
    # Método que devuelve la cantidad de puntos ganados
    def obtener_puntos(self):
        '''
            Determina los puntos de acuerdo a los dados que se tiene
            
            Returns:
                int: puntos a retornar
        '''      
